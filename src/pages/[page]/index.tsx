...
import { HeaderText, SubHeaderText, Thumb, Loading } from "../../components"
      ...
      <div className={"flex flex-col text-center bg-zinc-800 m-12 rounded-xl py-8"}>
        ...
        <div className={"flex flex-row flex-wrap justify-center"}>
          {popularDoujins.map((doujin: Doujin) => {
            return <Thumb key={doujin.id} src={createThumb(doujin.media_id, doujin.images.cover.t)} doujin={doujin} />
          })}
        </div>
      </div>
      <div className={"flex flex-col text-center bg-zinc-800 m-12 rounded-xl py-8"}>
